<template>
  <div class="q-px-lg q-py-sm">
    ...
    <div class="q-pa-md q-mt-lg row">
      <!-- 示例 -->
      <div
        class="col q-mx-lg q-pa-md example-container column justify-center"
      ...
      >
        ...
        <div class="q-my-md row q-gutter-md justify-center">
          <q-card
            class="column justify-center items-center shadow-3"
      ...
      <div class="column q-gutter-lg col-4 color-choose">
        <div v-for="key in Object.keys(defaultColor)" class="row items-center">
          <Transition name="dot">
            <div
              v-if="customTheme.color[key]"
              class="color-dot q-mr-sm"
              :style="`background-color: ${customTheme.color[key]}`"
            ></div>
          </Transition>
    ...
    <q-card style="min-width: 350px; background-color: var(--q-bg)">
      ...
      <q-card-section class="q-pt-none">
        <q-input
          ...
          :rules="[(val) => checkThemeName(val) || '已存在该名称的主题！']"
        />
      </q-card-section>
...
// 获取本地内存的自定义主题
const ct = localStorage.getItem('custom-theme')
  ? JSON.parse(localStorage.getItem('custom-theme') as string)
  : {
      active: '',
      error: '',
      bg: '',
