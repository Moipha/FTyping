...
export default function (typingResult: Ref<TypingResult>, curIndex: Ref<[number, number]>, showResult: Ref<boolean>) {
  // 获取store中的数据
  ...
  function handleEnd(enWords: Block[]) {
    ...
    addTypingRecord({
      ...
      mode: 'timed',
      total_words: enWords.length,
      accuracy: correctnessNumber
    })
  }
